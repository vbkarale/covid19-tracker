        ...
        if (pie_donut_element) {
            ...
            pie_donut.setOption({
                ...
                series: [{
                    ...
                    data: [
                        { value: $('.caseLouisiana').text(), name: 'Louisiana' },
                        { value: $('.caseIllinois').text(), name: 'Illinois' },
                        { value: $('.casePennsylvania').text(), name: 'Pennsylvania' },
                        { value: $('.caseWashington').text(), name: 'Washington' },
                        { value: $('.caseFlorida').text(), name: 'Florida' },
                        { value: $('.caseCalifornia').text(), name: 'California' },
                        { value: $('.caseNewYork').text(), name: 'New York' },
                        { value: $('.caseMichigan').text(), name: 'Michigan' },
                        { value: $('.caseMaryland').text(), name: 'Maryland' },
                        { value: $('.caseTexas').text(), name: 'Texas' },
                        { value: $('.caseGeorgia').text(), name: 'Georgia' },
                        { value: $('.caseNewJersey').text(), name: 'New Jersey' },
                        { value: $('.caseMassachusetts').text(), name: 'Massachusetts' },
                        { value: $('.caseConnecticut').text(), name: 'Connecticut' },
                    ]
                }]
            });
        }
        ...
        if (pie_nested_element) {
            ...
            pie_nested.setOption({
                ...
                legend: {
                    ...
                    top: 'center',
                    left: 0,
                    data: ['USA', 'Spain', 'Italy', 'France', 'Germany', 'UK', 'Iran', 'Turkey', 'Belgium', 'Switzerland', 'Netherlands', 'Canada', 'Brazil', 'India'],
                    itemHeight: 8,
                    itemWidth: 8
                },
                ...
                series: [
                    ...
                    // Inner
                    {
                        ...
                        data: [
                            ...
                            { value: 1548, name: 'France' },
                            { value: 1548, name: 'Germany' }
                        ]
                    },
                    ...
                    // Outer
                    {
                        ...
                        data: [
                            { value: 535, name: 'UK' },
                            { value: 310, name: 'Iran' },
                            { value: 234, name: 'Turkey' },
                            { value: 135, name: 'Belgium' },
                            { value: 948, name: 'Switzerland' },
                            { value: 251, name: 'Netherlands' },
                            { value: 147, name: 'Canada' },
                            { value: 202, name: 'India' },
                            { value: 202, name: 'Brazil' }
                        ]
                    }
                ]
            });
