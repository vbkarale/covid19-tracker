    ...
    var _columnsWaterfallsExamples = function () {
        ...
        if (columns_stacked_element) {
            ...
            columns_stacked.setOption({
                ...
                // Add legend
                legend: {
                    data: ['Confirmed', 'Active', 'Deaths', 'Recovered', 'New Confirm', 'New Deaths', 'New Recovered'],
                    itemHeight: 8,
                    itemGap: 20
                },
                ...
                xAxis: [{
                    type: 'category',
                    data: ['MAH', 'DL', 'TN', 'RJ', 'MP', 'TG', 'GJ', 'UP', 'AP', 'KL', 'J&K', 'KA', 'HR', 'PB', 'WB'],
                    axisLabel: {
                        color: '#333'
                    },
                    axisLine: {
                ...
                series: [
                    {
                        name: 'Confirmed',
                        type: 'bar',
                        data: [$('.caseMH').text(), $('.caseDL').text(), $('.caseTN').text(), $('.caseRJ').text(), $('.caseMP').text(), $('.caseTG').text(), $('.caseGJ').text(), $('.caseUP').text(), $('.caseAP').text(), $('.caseKL').text(), $('.caseJK').text(), $('.caseKA').text(), $('.caseHR').text(), $('.casePB').text(), $('.caseWB').text()]
                    },
                    {
                        name: 'Active',
                        type: 'bar',
                        stack: 'Advertising',
                        data: [$('.activeMH').text(), $('.activeDL').text(), $('.activeTN').text(), $('.activeRJ').text(), $('.activeMP').text(), $('.activeTG').text(), $('.activeGJ').text(), $('.activeUP').text(), $('.activeAP').text(), $('.activeKL').text(), $('.activeJK').text(), $('.activeKA').text(), $('.activeHR').text(), $('.activePB').text(), $('.activeWB').text()]
                    },
                    {
                        name: 'Deaths',
                        type: 'bar',
                        stack: 'Advertising',
                        data: [$('.deathsMH').text(), $('.deathsDL').text(), $('.deathsTN').text(), $('.deathsRJ').text(), $('.deathsMP').text(), $('.deathsTG').text(), $('.deathsGJ').text(), $('.deathsUP').text(), $('.deathsAP').text(), $('.deathsKL').text(), $('.deathsJK').text(), $('.deathsKA').text(), $('.deathsHR').text(), $('.deathsPB').text(), $('.deathsWB').text()]
                    },
                    {
                        name: 'Recovered',
                        type: 'bar',
                        stack: 'Advertising',
                        data: [$('.recoveredMH').text(), $('.recoveredDL').text(), $('.recoveredTN').text(), $('.recoveredRJ').text(), $('.recoveredMP').text(), $('.recoveredTG').text(), $('.recoveredGJ').text(), $('.recoveredUP').text(), $('.recoveredAP').text(), $('.recoveredKL').text(), $('.recoveredJK').text(), $('.recoveredKA').text(), $('.recoveredHR').text(), $('.recoveredPB').text(), $('.recoveredWB').text()]
                    },
                    {
                        name: 'New Confirm',
                        type: 'bar',
                        stack: 'Advertising',
                        data: [$('.deltacMH').text(), $('.deltacDL').text(), $('.deltacTN').text(), $('.deltacRJ').text(), $('.deltacMP').text(), $('.deltacTG').text(), $('.deltacGJ').text(), $('.deltacUP').text(), $('.deltacAP').text(), $('.deltacKL').text(), $('.deltacJK').text(), $('.deltacKA').text(), $('.deltacHR').text(), $('.deltacPB').text(), $('.deltacWB').text()]
                    },
                    {
                        name: 'New Deaths',
                        type: 'bar',
                        stack: 'Television',
                        data: [$('.deltadMH').text(), $('.deltadDL').text(), $('.deltadTN').text(), $('.deltadRJ').text(), $('.deltadMP').text(), $('.deltadTG').text(), $('.deltadGJ').text(), $('.deltadUP').text(), $('.deltadAP').text(), $('.deltadKL').text(), $('.deltadJK').text(), $('.deltadKA').text(), $('.deltadHR').text(), $('.deltadPB').text(), $('.deltadWB').text()]
                    },
                    {
                        name: 'New Recovered',
                        type: 'bar',
                        stack: 'Television',
                        data: [$('.deltarMH').text(), $('.deltarDL').text(), $('.deltarTN').text(), $('.deltarRJ').text(), $('.deltarMP').text(), $('.deltarTG').text(), $('.deltarGJ').text(), $('.deltarUP').text(), $('.deltarAP').text(), $('.deltarKL').text(), $('.deltarJK').text(), $('.deltarKA').text(), $('.deltarHR').text(), $('.deltarPB').text(), $('.deltarWB').text()]
                    }
                ]
            });
        }
